                    ...
                    <div className="h-full w-full md:w-3/6 flex flex-col gap-5 justify-center text-start">
                        ...
                        <InView triggerOnce={false}>
                            {({ inView, ref }) => (
                                ...
                                >
                                    <li>Web apps from concept to production with React & Next.js</li>
                                    <li>Native Android apps with Kotlin & Jetpack Compose</li>
                                    <li>REST APIs, JWT auth & real-time systems</li>
                                    <li>Clean Architecture · MVVM · Spring Boot · Node.js</li>
                                </motion.div>
                            )}
                        </InView>
